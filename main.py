...
#content_image = scipy.misc.imresize(content_image, size=(300,400,3))
content_image = util.reshape_and_normalize_image(content_image)

style_image = scipy.misc.imread("monet.jpg")
#style_image = scipy.misc.imresize(style_image, size=(300,400,3))
...
J = util.total_cost(J_content, J_style, alpha = 0.00001, beta = 0.00004)
